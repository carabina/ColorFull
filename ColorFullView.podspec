...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of ColorFullView."
  ...
  # Or just: s.author    = "Faisal AlMaarik"
  # s.authors            = { "Faisal AlMaarik" => "Faisal.it@icloud.com" }
  # s.social_media_url   = "http://twitter.com/Faisal AlMaarik"
  ...
  s.source_files  = "ColorfullView/ColorFullView.swift"
